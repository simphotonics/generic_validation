...
class TestValidatePositive:
    ...
    def test_message(self):
        try:
            ...
            assert 'Invalid argument in function f_positive: ' \
...
class TestValidateInInterval:
    ...
    def test_message(self):
        try:
            ...
            assert "f_in_interval: width = 5. " \
                   "Input x must satisfy: 10 <= x <= 20." in str(
                       e)
    ...
    def test_message_inverted_boundaries(self):
        try:
            ...
            assert "number = -25. Input x must satisfy: -20 <= x < 10." \
                   "" in str(e)
